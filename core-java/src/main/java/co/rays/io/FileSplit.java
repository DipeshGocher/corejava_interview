...
// 1. To count no. of line
		
		String s = "C:\\Users\\ACER\\OneDrive\\Desktop\\IO\\split.txt";
...
// 4. here we create files nof
		...
		for(int i = 1; i<= nof; i++) {
			...
			BufferedWriter bw =  new BufferedWriter(new FileWriter("C:\\Users\\ACER\\OneDrive\\Desktop\\IO\\After split" + i +".txt"));
